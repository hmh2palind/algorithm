   ...
   /**
    ...
    public In(String name) {
        ...
        try {
            ...
            URLConnection site = url.openConnection();
//            site.setConnectTimeout(TIMEOUT_VALUE);
//            site.setReadTimeout(TIMEOUT_VALUE);
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        System.getProperties().put("http.proxyHost", "fsoft-proxy");
        System.getProperties().put("http.proxyPort", "8080");
        In in;
        String urlName = "http://introcs.cs.princeton.edu/stdlib/InTest.txt";
        //urlName = "http://tratu.soha.vn/dict/en_vn/Political";
